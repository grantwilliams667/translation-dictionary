...
#include <string>
#include <limits>
#include <ctime> //for new cpu timing
#include "bst.h"

using namespace std;

//functions that reads the dictionary file and inserts it
void read(string filename, BinarySearchTree &dictionary)
{
...
int main()
{
    ...
    //convert clock into seconds
    double cpu_time = double(final - initial) / CLOCKS_PER_SEC;
    
    //print time
    cout << "BST CPU time: "<< cpu_time << " seconds" << endl;
    int choice = -1;
    //menu 
    while (true)
{
